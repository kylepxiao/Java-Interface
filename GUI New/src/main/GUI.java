...
public class GUI extends GUI_Instance implements ActionListener{
	...
	private static String path[] = {"C:\\Program Files\\Java\\jre1.8.0_45\\bin"};
	...
	private void setContent(){
		GridBagLayout gbl_all = new GridBagLayout();
		this.getContentPane().setLayout(gbl_all);
		...
		gbc_p_palette.insets = new Insets(5, 5, 5, 5);
		...
		gbc_p_workspace.insets = new Insets(5, 5, 5, 5);
		...
		gbc_p_browser.insets = new Insets(5, 5, 5, 5);
		...
		gbc_p_output.insets = new Insets(5, 5, 5, 5);
		...
		gbc_p_console.insets = new Insets(5, 5, 5, 5);
		...
		gbc_p_information.insets = new Insets(5, 5, 5, 5);
